...
const ReportPage = () => {
  ...
  // Helmet will handle title and meta tags instead of useEffect
  ...
  const handleDownload = async () => {
    try {
      ...
      link.href = 'https://cultark.com/wp-content/uploads/2025/08/AiReport.pdf';
  ...
  return (
    <div className="pt-24 lg:pt-36 min-h-screen">
      <Helmet>
        <title>AI Industry Report 2025 - Comprehensive AI Trends Analysis | CULTARK</title>
        <meta name="description" content="Download our comprehensive AI Industry Report 2025 exploring the latest trends in artificial intelligence, machine learning, and AI's transformative impact across industries. Get expert insights on AI implementation strategies." />
        <meta name="keywords" content="AI report 2025, artificial intelligence trends, AI industry analysis, machine learning insights, AI implementation guide, business AI transformation" />
        
        {/* Open Graph for social sharing */}
        <meta property="og:title" content="AI Industry Report 2025 - Comprehensive AI Trends Analysis" />
        <meta property="og:description" content="Download our comprehensive AI Industry Report exploring the latest trends in artificial intelligence and its impact across various industries. Expert insights and implementation strategies." />
        <meta property="og:image" content="https://cultark.com/images/og-ai-report.jpg" />
        <meta property="og:url" content="https://cultark.com/report" />
        ...
        <meta name="twitter:title" content="AI Industry Report 2025 - Comprehensive AI Trends Analysis" />
        <meta name="twitter:description" content="Download our comprehensive AI Industry Report exploring the latest trends in artificial intelligence and its impact across various industries." />
        <meta name="twitter:image" content="https://cultark.com/images/og-ai-report.jpg" />
      ...
      <div className="max-w-[110rem] mx-auto px-4 md:px-8 lg:px-12 mb-10">
        ...
        <div className="w-full rounded-2xl overflow-hidden border border-gray-200 shadow-lg mb-8">
          <div className="bg-gray-100 p-3 border-b border-gray-200 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://cultark.com/wp-content/uploads/2025/08/AiReport.pdf"
                target="_blank"
            ...
            <ErrorBoundary>
              <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
                <div className="h-[70vh] md:h-[75vh] lg:h-[80vh] bg-white border-t border-gray-200">
                  <Viewer
                    fileUrl="https://cultark.com/wp-content/uploads/2025/08/AiReport.pdf"
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-4 items-start sm:items-center">
          ...
          >
            <span>{downloadMutation.isLoading ? 'Downloading...' : 'Download Report'}</span>
            <FaDownload size={16} />
          </button>
        ...
        {/* <div className="mt-16 border-t pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">AI in Business Operations</h3>
                <p className="text-gray-600 mb-4">Learn how AI is transforming business operations across industries.</p>
                <button
                  onClick={() => window.location.href = '/blog'}
                  className="text-cultark-blue font-medium hover:underline flex items-center gap-2"
                >
                  Read Article
                </button>
              </div>
            ...
            <div className="border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Future of AI Technology</h3>
                <p className="text-gray-600 mb-4">Explore the upcoming trends and innovations in artificial intelligence.</p>
                <button
                  onClick={() => window.location.href = '/blog'}
                  className="text-cultark-blue font-medium hover:underline flex items-center gap-2"
                >
            ...
            <div className="border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">Step-by-step guide to implementing AI solutions in your organization.</p>
                <button
