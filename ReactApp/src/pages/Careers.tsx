...
const Careers = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      return submitToCareersGoogle(formData)
      // applyToCareers(`/wp-admin/admin-ajax.php`, formData);
  ...
  return (
    <div className='bg-gray-400 min-h-screen flex flex-col items-center justify-center bg-[url("/images/careers-back.jpeg")] bg-cover font-manrope relative md:p-10 p-5 pt-28'>
      ...
      <div className='bg-black/40 container lg:w-[75%] xl:w-[60%] rounded-xl backdrop-blur-md py-10 md:px-14 px-8  text-white mb-5'>
