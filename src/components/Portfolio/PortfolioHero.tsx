...
const PortfolioHero = () => {
    return (
        <div className='bg-gray-400 h-screen flex flex-col items-center text-center justify-center bg-[url("/images/portfolio_hero.jpg")] bg-cover bg-top font-manrope relative'>
            <div className='bg-black/60 h-screen absolute inset-0 z-1'></div>
            <div className='relative z-10 flex flex-col items-center text-center justify-center gap-2'>
                <Image src='/images/paytab_logo.png' alt='Paytab Logo' width={200} height={100} priority />
                <h1
