...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: {
            ...
            images: [
                {
                    url: `https://backup.cultark.net/images/docs/${doc.slug}.jpg`,
                    width: 1200,
                    height: 630,
                    alt: `${doc.name} Case Study`,
                },
            ],
            url: `https://backup.cultark.net/case-studies/${slug}`,
            type: 'article',
            siteName: 'CULTARK',
        },
        twitter: {
            ...
            title: `${doc.name} - Case Study & Report`,
            description: `${doc.description} - Comprehensive case study and analysis from CULTARK's industry reports collection.`,
            images: [`https://backup.cultark.net/images/docs/${doc.slug}.jpg`],
            site: '@cultark',
            creator: '@cultark',
        },
        other: {
